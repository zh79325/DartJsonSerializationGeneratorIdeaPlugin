...
/**
 * @author zh_zhou
 * created at 2019/06/24 23:33
 * Copyright [2019] [zh_zhou]
 */
public abstract class BaseDartCreateFileAction extends AnAction {
    ...
    public void actionPerformed(final AnActionEvent e) {
        ...
        Editor editor=editorAndPsiFile.first;
        PsiFile second=editorAndPsiFile.second;
        getGenerateHandler().invoke(project, editor, second);
    }
    ...
    @NotNull
    protected abstract BaseDartCreateHandler getGenerateHandler();
