...
/**
 * @author zh_zhou
 * created at 2019/06/25 11:18
 * Copyright [2019] [zh_zhou]
 */
public abstract class BaseDartCreateHandler implements LanguageCodeInsightActionHandler {
    @Override
    ...
    protected void doInvoke(@NotNull final Project project,
                            ...
                            @NotNull final BaseCreateFileFix createMethodsFix) {
    ...
    @NotNull
    protected abstract BaseCreateFileFix createFix(@NotNull final DartClass dartClass);
